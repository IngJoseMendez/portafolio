export default function Header() {
    return (
        <header className="bg-gray-900 flex items-center p-3 w-full justify-between pb-20 pt-5">
            ...
            <nav>
                <button className="text-white md:mr-50 flex justify-center px-3 py-3 items-center gap-8 bg-transparent font-bold rounded-lg shadow-md border-2 border-amber-100
                    hover:scale-105 hover:shadow-lg transition-all duration-200 active:scale-95 focus-ring-2 text-[1.5rem] ">conversemos
