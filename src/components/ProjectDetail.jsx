                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gray-800 p-4 md:p-6 rounded-xl border border-gray-700">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-2 md:py-3 bg-amber-600 hover:bg-amber-500 text-white rounded-lg transition-all font-bold shadow-lg text-sm md:text-base">
